...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'createdBy', targetEntity: GiftList::class, orphanRemoval: true)]
    ...
    public function removeGiftList(GiftList $giftList): static
    {
        if ($this->giftLists->removeElement($giftList)) {
            ...
            if ($giftList->getCreatedBy() === $this) {
                $giftList->setCreatedBy(null);
            }
        }
